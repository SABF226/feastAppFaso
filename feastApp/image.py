...
class Application(tk.Tk):
    def __init__(self):
        ...
        # === AJOUT DE L'ICÔNE ===
        # Pour Windows (format .ico)
        format.iconbitmap("icon_feastApp.ico")
        # Si tu veux utiliser un .png ou .jpg (pour Linux/Mac/Windows moderne), décommente la ligne suivante :
        format.iconbitmap(False, PhotoImage(file="icon_feastApp.ico"))
        # ========================
